...
public class Wheel3DView extends WheelView {
    ...
    protected void drawItem(Canvas canvas, int index, int offset) {
        ...
        if (range > 0 && range < mItemHeight) {
            ...
            drawText(canvas, text, centerX, centerY, 0, translateY, translateZ, rotate,
                    mSelectedTextPaint);
            canvas.restore();
    ...
    private void drawText(Canvas canvas, CharSequence text, float centerX, float centerY,
