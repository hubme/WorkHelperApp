...
class BannerAdapter extends PagerAdapter {
    private final List<SimpleDraweeView> mBannerViews = new ArrayList<>();
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        final SimpleDraweeView imageView = mBannerViews.get(position);
    ...
    public void update(List<SimpleDraweeView> bannerViews) {
