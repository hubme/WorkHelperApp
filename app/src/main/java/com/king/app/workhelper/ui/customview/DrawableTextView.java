...
public class DrawableTextView extends AppCompatTextView {
    ...
    public DrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            array = context.obtainStyledAttributes(attrs, R.styleable.DrawableTextView);
        ...
        if (drawables[0] != null && widths[0] == 0 && heights[0] == 0) {
            widths[0] = drawables[0].getIntrinsicWidth();
            heights[0] = drawables[0].getIntrinsicHeight();
        }

        if (drawables[1] != null && widths[1] == 0 && heights[1] == 0) {
            widths[1] = drawables[1].getIntrinsicWidth();
            heights[1] = drawables[1].getIntrinsicHeight();
        }

        if (drawables[2] != null && widths[2] == 0 && heights[2] == 0) {
            widths[2] = drawables[2].getIntrinsicWidth();
            heights[2] = drawables[2].getIntrinsicHeight();
        }

        if (drawables[3] != null && widths[3] == 0 && heights[3] == 0) {
            widths[3] = drawables[3].getIntrinsicWidth();
            heights[3] = drawables[3].getIntrinsicHeight();
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawables[1] != null) {
            ...
            drawables[1].setBounds(left, bottom - heights[1], left + widths[1],
                    bottom);
            canvas.save();
