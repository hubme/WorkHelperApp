...
public class ScanRecordUtil {
    ...
    // The following data type values are assigned by BluetoothScan SIG.
    // For more details refer to BluetoothScan 4.1 specification, Volume 3, Part C, Section 18.
    ...
    // Local name of the BluetoothScan LE device.
     ...
     * <p>
     * The format is defined in BluetoothScan 4.1 specification, Volume 3, Part C, Section 11 and 18.
     * <p>
     * All numerical multi-byte entities and values shall use little-endian <strong>byte</strong>
     * order.
     *
     * @param scanRecord The scan record of BluetoothScan LE advertisement and/or scan response.
     * @hide
     */
