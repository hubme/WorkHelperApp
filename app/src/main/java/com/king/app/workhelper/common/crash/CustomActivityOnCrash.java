...
public final class CustomActivityOnCrash {
    ...
    private static int defaultErrorActivityDrawableId = R.mipmap.crashed_image;
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CustomActivityOnCrash.EXTRA_IMAGE_DRAWABLE_ID, R.mipmap.crashed_image);
    }
    ...
    private static Class<? extends Activity> guessErrorActivityClass(Context context) {
        ...
        //Else, get the default launcher activity
        if (resolvedActivityClass == null) {
            resolvedActivityClass = CrashedActivity.class;
        }
