...
import com.king.applib.jsbridge.JsBridgeWebChromeClient;
...
public class WebActivity extends AppBaseActivity {
    ...
    private class DefaultWebChromeClient extends JsBridgeWebChromeClient {
        @Override
        ...
        @Override
        public void onReceivedIcon(WebView view, Bitmap icon) {//获取网页的图标
        ...
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue,
            ...
            if (message != null && defaultValue != null && defaultValue.contains(
                    PREFIX_JS_PROTOCOL)) {
    ...
    public static void openActivity(Context context, String url) {
        new IntentBuilder(context, WebActivity.class).put(GlobalConstant.INTENT_PARAMS_KEY.WEB_URL,
                url).start();
    }
    ...
    public void onTestClick() {
        ...
        mUrl = mInputEt.getText().toString().trim();
        loadUrl();
    }
